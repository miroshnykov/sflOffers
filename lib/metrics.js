...
exports.sendMetricsSystem = function (fileSizeOffer, fileSizeCampaign, fileSizeAffiliates, fileSizeAffiliateWebsites, clientsCount) {
    if (config.env === 'development') return
    ...
    let fields = {
        ...
        file_size_campaigns_recipe: fileSizeCampaign,
        file_size_offers_recipe: fileSizeOffer,
        file_size_affiliates_recipe: fileSizeAffiliates,
        file_size_affiliate_websites: fileSizeAffiliateWebsites,
